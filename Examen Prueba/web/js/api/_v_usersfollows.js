...
const v_usersfollowsAPI_auto = {

    /** Gets all entries from 'v_usersfollows' */
    getAll: async function() {
        let response = await axios.get(`${BASE_URL}/v_usersfollows`, requestOptions);
        return response.data;
    },
};

export { v_usersfollowsAPI_auto };