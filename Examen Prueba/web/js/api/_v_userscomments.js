...
const v_userscommentsAPI_auto = {

    /** Gets all entries from 'v_userscomments' */
    getAll: async function() {
        let response = await axios.get(`${BASE_URL}/v_userscomments`, requestOptions);
        return response.data;
    },
};

export { v_userscommentsAPI_auto };